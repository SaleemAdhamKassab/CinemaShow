...
namespace AngularToAPI.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await SendEmail.SendEmailAsync(user.Email, user.UserName,confirmLink);
        ...
        public async Task<IActionResult> Login(LoginModel model)
        {
            ...
            {
                return Unauthorized("As a result of incorrect registration, the account has been temporarily blocked");
            }
        ...
        public async Task<IActionResult> ForgetPassword(string email)
        {
            ...
            //if (await SendGridAPI.SendEmailAsync("ssss"))
            //{
